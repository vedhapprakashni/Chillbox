...
const MoodSelection = () => {
    ...
    const handleMoodSelect = (mood) => {
        // Ideally save mood to context/local storage here
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <NeoCard
                    className="bg-primary hover:bg-opacity-80 cursor-pointer transition-colors"
                ...
                <NeoCard
                    className="bg-secondary hover:bg-opacity-80 cursor-pointer transition-colors"
                ...
                <NeoCard
                    className="bg-chill-purple hover:bg-opacity-80 cursor-pointer transition-colors"
                    onClick={() => handleMoodSelect('low-focus')}
                >
